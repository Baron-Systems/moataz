...
async function main() {
  ...
  // Seed work schedule (Sunday to Thursday, 9:00 - 17:00)
  const workDays = [
  ...
  const testimonials = [
    {
      name: 'عرين محمد',
      text: 'بدأت رحلتي الصحية عام 2018 بعد إصابتي بالتهاب فيروسي أثر على النخاع الشوكي وأدى إلى فقدان القدرة على الحركة والاعتماد على الكرسي المتحرك. وبعد سنوات من التحديات الصحية، عانيت من قرحة فراش عميقة استمرت لأشهر طويلة دون تحسن يُذكر. راجعت أخصائي الجروح والقدم السكري معتز أبو إرميلة. وخلال الزيارة الأولى تم تقييم الحالة ووضع خطة علاجية واضحة. وبفضل الله ثم بفضل الخبرة والمتابعة المستمرة، التئم الجرح بشكل كامل.',
      publishedAt: new Date('2024-01-15'),
    },
    {
      name: 'إسماعيل جحشن',
      text: 'أتقدم بخالص الشكر والتقدير لمركز الجروح والقدم السكري D.F.C وللأخصائي معتز أبو إرميلة على الرعاية والاهتمام والمتابعة المستمرة. خضعت لجلسات علاج متخصصة لعلاج تقرحات القدم، ولمست تحسناً واضحاً وتقدماً ملموساً خلال فترة العلاج.',
      publishedAt: new Date('2024-02-20'),
    },
    {
      name: 'أم غالب النشناشة',
      text: 'كل الشكر والتقدير لمركز الجروح والقدم السكري D.F.C على حسن الاستقبال والاهتمام والرعاية المقدمة للمرضى. نتمنى لكم المزيد من النجاح والتوفيق.',
      publishedAt: new Date('2024-03-10'),
    },
    {
      name: 'أم محمود عبيدة',
      text: 'مركز متميز في التعامل مع المرضى بكل احترام واهتمام. نشكر الأخصائي معتز أبو إرميلة وفريق العمل على أخلاقهم العالية وحرصهم الدائم على راحة المرضى.',
      publishedAt: new Date('2024-04-05'),
    },
    {
      name: 'مصعب أبو سنينة',
      text: 'بعد سنوات من المعاناة، تابعت حالتي لدى الأخصائي معتز أبو إرميلة. بفضل الله ثم بفضل الخبرة والمتابعة المستمرة تحسنت حالتي بشكل كبير. أشكر المركز على الرعاية والاهتمام والمتابعة الدائمة.',
